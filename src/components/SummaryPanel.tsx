...
import { FitLevel } from "@/lib/structuredNeed";
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right text-sm">
            <p>Importance : {levelLabel[data.strategicFit.importance]}</p>
            <p>Fréquence : {levelLabel[data.strategicFit.frequency]}</p>
          </div>
        </div>
          ...
          {gridLevels.map((importance) =>
            gridLevels.map((frequency) => (
              <div
                ...
                className={cn(
                  "aspect-square rounded-lg border border-zinc-200 bg-zinc-50",
